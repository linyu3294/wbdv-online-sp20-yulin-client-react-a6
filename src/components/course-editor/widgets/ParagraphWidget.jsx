                            ...
                            <div className="card-body">
                                ...
                                <div className="row my-2">
                                    <div className="col-12">
                                        <select className="form-control" onChange={(e) => this.handleSizeChange(e)} value={this.state.widget.textSize}>
                                            <option value="1">FontSize 1</option>
                                            <option value="2">FontSize 2</option>
                                            <option value="3">FontSize 3</option>
                                            <option value="4">FontSize 4</option>
                                            <option value="5">FontSize 5</option>
                                            <option value="6">FontSize 6</option>
                                        </select>
                                    </div>
                                </div>
                                <div className="row my-2">
                                ...
                                <div className="row">
                                    <div className="col-12 my-2">
                                        <h4>Preview</h4>
                                        <ParagraphPreview text={this.state.widget.text} size={this.state.widget.textSize}/>
                                    </div>
                                </div>
                            </div>
                        </div>
